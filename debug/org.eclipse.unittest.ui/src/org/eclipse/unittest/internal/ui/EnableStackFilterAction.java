...
public class EnableStackFilterAction extends Action {
	...
	public EnableStackFilterAction(FailureTraceUIBlock view) {
		...
		setHoverImageDescriptor(Images.getImageDescriptor("elcl16/cfilter.svg")); //$NON-NLS-1$
		setImageDescriptor(Images.getImageDescriptor("elcl16/cfilter.svg")); //$NON-NLS-1$
