...
public class DebugPluginImages {
	...
	private static void declareImages() {
		...
		declareRegistryImage(IInternalDebugUIConstants.IMG_DLCL_CHANGE_VARIABLE_VALUE,
				DLCL + "changevariablevalue_co.png"); //$NON-NLS-1$
		...
		declareRegistryImage(IInternalDebugUIConstants.IMG_DLCL_COPY_VIEW_TO_CLIPBOARD,
				DLCL + "copyviewtoclipboard_tsk.svg"); //$NON-NLS-1$
		...
		declareRegistryImage(IInternalDebugUIConstants.IMG_ELCL_REMOVE, ELCL + "rem_co.svg"); //$NON-NLS-1$
		...
		declareRegistryImage(IInternalDebugUIConstants.IMG_WIZBAN_IMPORT_BREAKPOINTS,
				WIZBAN + "import_brkpts_wizban.svg"); //$NON-NLS-1$
		declareRegistryImage(IInternalDebugUIConstants.IMG_WIZBAN_EXPORT_BREAKPOINTS,
				WIZBAN + "export_brkpts_wizban.svg"); //$NON-NLS-1$
