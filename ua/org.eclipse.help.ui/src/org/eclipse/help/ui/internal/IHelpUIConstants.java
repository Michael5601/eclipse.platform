...
public interface IHelpUIConstants {
	...
	public static final String IMAGE_FILE_F1TOPIC = "obj16/topic_small.svg"; //$NON-NLS-1$
	public static final String IMAGE_COMMAND_F1TOPIC = "obj16/command_small.svg"; //$NON-NLS-1$

	// Help view images
	public static final String IMAGE_CONTAINER = "obj16/container_obj.svg"; //$NON-NLS-1$
	public static final String IMAGE_TOC_CLOSED = "obj16/toc_closed.svg"; //$NON-NLS-1$
	public static final String IMAGE_TOC_OPEN = "obj16/toc_open.svg"; //$NON-NLS-1$
	public static final String IMAGE_BOOKMARKS = "obj16/bookmarks_view.svg"; //$NON-NLS-1$
	public static final String IMAGE_BOOKMARK = "obj16/bookmark_obj.svg"; //$NON-NLS-1$
	public static final String IMAGE_HELP_SEARCH = "etool16/helpsearch_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_HELP_PRINT = "etool16/print_topic.svg"; //$NON-NLS-1$
	public static final String IMAGE_RELATED_TOPICS = "etool16/reltopics_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_ALL_TOPICS = "etool16/alltopics_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_INDEX = "etool16/index_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_HELP = "etool16/help.svg"; //$NON-NLS-1$
	public static final String IMAGE_DHELP = "view16/help_view.svg"; //$NON-NLS-1$
	public static final String IMAGE_NW = "elcl16/openseparate_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_SHOW_CATEGORIES = "elcl16/showcat_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_SHOW_DESC = "elcl16/showdesc_co.svg"; //$NON-NLS-1$
	public static final String IMAGE_ADD_BOOKMARK = "elcl16/addbkmrk_co.svg"; //$NON-NLS-1$
